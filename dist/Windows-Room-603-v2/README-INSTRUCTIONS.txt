...
------------------------------------------------------------
1. EXTRACT (2 clicks, folder is created automatically):
   - Copy "LectureAgent.zip" to the PC (Desktop is fine).
   - Right-click the zip -> "Extract All..."
   - In the path box, delete everything and type:   C:\
   - Click "Extract".
   Windows now creates C:\LectureAgent automatically with all files
   directly inside it - no extra folder, nothing else to do.
   (Nothing to install - .NET and everything else is in the folder)
