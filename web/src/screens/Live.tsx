      ...
      <div className="bg-white border border-slate-200/90 rounded-2xl p-4 shadow-sm">
        ...
        <div className="space-y-2 text-xs">
          ...
          <div className="flex justify-between py-1 border-b border-slate-100">
            ...
            <span className="font-mono text-slate-800 truncate max-w-[180px]" title={agentInfo?.monitorFolder}>
      ...
      <div className="space-y-2">
        ...
        {snapshot?.queue.length === 0 ? (
          <div className="bg-white border border-slate-200/90 rounded-2xl p-6 text-center text-slate-500 text-xs shadow-sm">
            No active uploads in queue. Drop a recording or PDF into{' '}
            <code className="text-cyan-700 font-mono bg-cyan-50 px-1 py-0.5 rounded border border-cyan-200">{agentInfo?.monitorFolder || 'the monitored folder'}</code> to test!
          </div>
        ) : (
          <div className="space-y-2">
                ...
                <div key={item.queueEntryId} className="bg-white border border-slate-200/90 rounded-2xl p-3.5 shadow-sm space-y-2">
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <span className="text-xs font-semibold text-slate-800 truncate">{item.fileName}</span>
                    </div>
