        ...
        <div className="space-y-2.5">
          ...
          {failedQueueItems.map((item) => (
            <div
              ...
              className="bg-rose-50/70 border border-rose-200 rounded-2xl p-4 space-y-3 shadow-xs"
            >
              ...
              return (
                <div key={item.lectureSessionId} className="bg-white border border-slate-200/90 rounded-2xl p-4 shadow-sm space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-2 pt-1 border-t border-slate-100">
                    <ActionButton tone="emerald" onClick={() => onApprove(item)} disabled={busy} className="py-2 text-xs">
                ...
                >
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t border-slate-100">
                    <button
                      ...
                      className="flex-1 py-1.5 px-2.5 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-white font-bold text-xs shadow-xs flex items-center justify-center gap-1.5 active:scale-95 transition disabled:opacity-40"
                    >
                      <UploadCloud className="w-3.5 h-3.5" />
                    ...
                    <button
                      ...
                      onClick={() => onEdit(item)}
                      disabled={busy}
                      className="py-1.5 px-2.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 font-semibold text-xs flex items-center justify-center gap-1.5 active:scale-95 transition"
                    >
                    ...
                    <button
                      ...
                      disabled={busy}
                      className="py-1.5 px-2.5 rounded-xl bg-rose-50 hover:bg-rose-100 border border-rose-200 text-rose-700 font-semibold text-xs flex items-center justify-center gap-1 active:scale-95 transition"
            ...
            <input
              ...
              onChange={(e) => {
                if (e.target.files && e.target.files.length > 0) {
                  ...
                  // Default subject or batch if empty
                  if (!uploadSubject) {
              ...
              className="w-full text-xs text-slate-600 file:mr-3 file:py-2 file:px-3 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-cyan-50 file:text-cyan-700 hover:file:bg-cyan-100 cursor-pointer border border-slate-200 rounded-xl p-1 bg-white"
              required
            />
            {selectedFile && (
